...
<c:forEach var="slider" items="${info}">
    <div>
        <p>Image Name: ${slider.moveImgName}</p>
        <p>Image Path: ${slider.moveImgPath}</p>
        <p>Video Name: ${slider.moveVidName}</p>
        <p>Video Path: ${slider.moveVidPath}</p>
    </div>
</c:forEach>
