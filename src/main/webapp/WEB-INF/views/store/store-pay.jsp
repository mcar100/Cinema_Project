...
<link rel="stylesheet" type="text/css"
	href="${contextPath}/resources/static/css/store/store-pay.css">
</head>
<body>
							...
							<div id="mCSB_1"
								...
								<div id="mCSB_1_container"
									...
									<div class="group_payment">
										...
										<div class="bx_cate">
											<ul class="list_pay_item cate6" style="height: 170px;">
												<li><button type="button" class="cate1 "
														>신용카드</button></li>
												<li><button type="button" class="cate2 ">엘페이</button></li>
												<li><button type="button" class="cate3 active">
														<em class="ic_txt_event type2 active">EVENT</em>간편결제 
													</button></li>
												<li><button type="button" class="cate5 ty2 ">내통장결제</button></li>
											</ul>
										</div>
										<div class="article_pay_simple" style="height:130px">
											<ul class="list_pay_item cate3">
												<li><button class="pay_simple_btn_box" type="button" onclick="requestKaKao()">
														<span class="pay_simple_thm"><img
															src="https://www.lottecinema.co.kr/NLCHS/Content/images/payment/payment_simple_kakao.png"
															alt="카카오페이"></span><span class="pay_simple_tit">카카오페이</span>
													</button></li>
												<li><button class="pay_simple_btn_box" type="button" onclick="requestPayco()">
														<span class="pay_simple_thm"><img
															src="https://www.lottecinema.co.kr/NLCHS/Content/images/payment/payment_simple_payco.png"
															alt="페이코"></span><span class="pay_simple_tit">페이코</span>
													</button></li>
												<li><button class="pay_simple_btn_box" type="button" onclick="reqeustNaverPay()">
														<span class="pay_simple_thm"><img
															src="https://www.lottecinema.co.kr/NLCHS/Content/images/payment/payment_simple_npay1.png"
															alt="네이버페이"></span><span class="pay_simple_tit">네이버페이</span>
													</button></li>
												<li><button class="pay_simple_btn_box" type="button" onclick="requestToss()">
														<span class="pay_simple_thm"><img
															src="https://www.lottecinema.co.kr/NLCHS/Content/images/payment/payment_simple_toss_221012.png"
															alt="토스"></span><span class="pay_simple_tit">토스</span><em
															class="ic_txt_event type2 active">EVENT</em>
													</button></li>
											</ul>
										</div>
									</div>
