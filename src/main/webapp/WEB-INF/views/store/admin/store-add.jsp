	  	...
	  	<form action="#" id="customerForm" class="tbl_form" data-url="/admin/customer/faqWrite">
			<table>
				<colgroup>
					...
					<tr>
						<th scope="row" class="req"><label for="categorySelect">물품 유형</label></th>
						<td>
					...
					<tr>
						...
						<td>
							<div class="bx_textarea">
								<input type="text" class="ty2 w_full" name="title" placeholder="상품 이름" />
							</div>
						</td>
					</tr>
					<tr>
						<th scope="row" class="req">상품 상세 설명</th>
						<td><textarea id="editor" class="ty2" name="content" placeholder="상품 상세 설명" ></textarea>	</td>
					</tr>
				</tbody>
			</table>
