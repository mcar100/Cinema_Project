	...
	<link rel="stylesheet" href="https://cdn.ckeditor.com/ckeditor5/42.0.0/ckeditor5.css">
  	...
  	<div id="contents">
		...
		<ul id="pageLink" class="tab_wrap outer">
			<li class="active"><button class="tab_tit" data-id="1" data-link="/admin/faqWrite" style="width: 20%; left: 0%;"><span>FAQ</span></button></li>
			<li><button class="tab_tit" data-id="2" data-link="/admin/noticeWrite" style="width: 20%; left:20%;"><span>공지사항</span></button></li>
		</ul>
		<hr/>
		<div id="adminContent">
